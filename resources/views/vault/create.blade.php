        ...
        <div class="col-lg-10 mx-auto">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('vault.store') }}" id="vaultItemForm">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select form-select-lg @error('type') is-invalid @enderror" id="type" name="type" required>
                                ...
                                <option value="env_file" {{ old('type') === 'env_file' ? 'selected' : '' }}>Archivo .env</option>
                            </select>
                            @error('type')
                        ...
                        <div id="envFileFields" class="item-type-fields" style="display: none;">
                            <div class="border-top pt-4 mb-4">
                                <h5 class="fw-light mb-3">Contenido del archivo .env</h5>
                                <label for="env_content" class="form-label">Pega el contenido de tu archivo .env</label>
                                <textarea class="form-control font-monospace @error('env_content') is-invalid @enderror"
                                          id="env_content" name="env_content" rows="12"
                                          placeholder="APP_NAME=MiApp&#10;APP_ENV=local&#10;DB_HOST=127.0.0.1&#10;DB_PASSWORD=secret">{{ old('env_content') }}</textarea>
                                <small class="text-body-secondary d-block mt-1">
                                    <i class="bi bi-info-circle"></i> Después de crear, podrás definir qué líneas o secciones son visibles para cada usuario.
                                </small>
                                @error('env_content')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="d-flex justify-content-end gap-2 border-top pt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle"></i> Crear Item
                            </button>
                        </div>
                    </form>
                </div>
